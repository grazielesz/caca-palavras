                    ...
                    this.posicaoPalavra.forEach((el, index) => {
                        if (el[0] == idx_x && el[1] == idx_y) {
                            ...
                            if (this.posicaoPalavra.length == 0 && this.idx + 1 != this.palavra.length) {
                                ...
                                document.getElementById("tempo").innerHTML = "GANHOU";
                                this.root.innerHTML = "<div id='final'><b>VOCÊ VENCEU!</b><br> Você conseguiu salvar Homer da prisão por sonegação de impostos e pode receber seu prêmio clicando <button id='venceu' onclick='document.location.href = \"https://www.infoescola.com/portugues/oracoes-coordenadas-adversativas\"'>aqui</button></div>"
                            }
...
let frases = [
    ...
    "Não obstante suas declarações de amor chegavam as orelhas de sua amada, logo ela deixou de amá-lo e trocou-o por um jogador de futebol flamenguista, quem a julgaria? Até ele se deixaria pelo jogador."
